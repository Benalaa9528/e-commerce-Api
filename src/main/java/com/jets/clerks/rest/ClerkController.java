...
public class ClerkController {
    @GET
    public Response getAllClerks(@HeaderParam("LoginId") String uuid) {
    ...
    @GET
    @Path("{id}")
    public Response getClerkById(@PathParam("id") int id, @HeaderParam("LoginId") String uuid) {
        CheckerDao checkerDao = new CheckerDao();
        var emp = checkerDao.getLoggedInEmployee(uuid);
        if (emp.getRole().equalsIgnoreCase("admin")) {
            ClerkDao clerkDao = new ClerkDao();
    ...
    public Response addClerk(ClerkPostDto clerkPostDto, @HeaderParam("LoginId") String uuid) {
        CheckerDao checkerDao = new CheckerDao();
        var emp = checkerDao.getLoggedInEmployee(uuid);
        if (emp.getRole().equalsIgnoreCase("admin")) {
    ...
    public Response updateClerk(@PathParam("id") int id, ClerkPostDto clerkPostDto,
            @HeaderParam("LoginId") String uuid) {
        CheckerDao checkerDao = new CheckerDao();
        var emp = checkerDao.getLoggedInEmployee(uuid);
        if (emp.getRole().equalsIgnoreCase("admin")) {
    ...
    @DELETE
    @Path("{id}")
    public Response deleteClerkById(@PathParam("id") int id, @HeaderParam("LoginId") String uuid) {
        CheckerDao checkerDao = new CheckerDao();
        var emp = checkerDao.getLoggedInEmployee(uuid);
        if (emp.getRole().equalsIgnoreCase("admin")) {
            ClerkDao clerkDao = new ClerkDao();
